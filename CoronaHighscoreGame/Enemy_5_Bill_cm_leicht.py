...
textsurface = myfont.render('BILL GATES', True, WHITE)
textsurface2 = myfont.render('CHRISTIAN', True, WHITE)

bg = pygame.image.load('/Corona/images/backgrounds/bg_bill.png')
screen_width = 960
screen_height = 720

pygame.display.set_caption('Corona - Bill Gates')
...
music = pygame.mixer.music.load('/Corona/sounds/music_bill.mp3')
...
class player(object):
    walkRight = [pygame.image.load('/Corona/images/char_armor_cm/R1.png'), pygame.image.load('/Corona/images/char_armor_cm/R2.png'), pygame.image.load('/Corona/images/char_armor_cm/R3.png'), pygame.image.load('/Corona/images/char_armor_cm/R4.png'), pygame.image.load('/Corona/images/char_armor_cm/R5.png'), pygame.image.load('/Corona/images/char_armor_cm/R6.png'), pygame.image.load('/Corona/images/char_armor_cm/R7.png'), pygame.image.load('/Corona/images/char_armor_cm/R8.png'), pygame.image.load('/Corona/images/char_armor_cm/R9.png'),pygame.image.load('/Corona/images/char_armor_cm/R10.png')]
    walkLeft = [pygame.image.load('/Corona/images/char_armor_cm/L1.png'), pygame.image.load('/Corona/images/char_armor_cm/L2.png'), pygame.image.load('/Corona/images/char_armor_cm/L3.png'), pygame.image.load('/Corona/images/char_armor_cm/L4.png'), pygame.image.load('/Corona/images/char_armor_cm/L5.png'), pygame.image.load('/Corona/images/char_armor_cm/L6.png'), pygame.image.load('/Corona/images/char_armor_cm/L7.png'), pygame.image.load('/Corona/images/char_armor_cm/L8.png'), pygame.image.load('/Corona/images/char_armor_cm/L9.png'),pygame.image.load('/Corona/images/char_armor_cm/L10.png')]
    char = pygame.image.load('/Corona/images/char_armor_cm/standing.png','/Corona/images/char_armor_cm/standing_normal.png')
    ...
    def hit(self):
        if goblin.enemy_health < 300:
            goblin.enemy_health += 30
            font3 = pygame.font.SysFont('Comic Sans MS', 135)
            text3 = font3.render ('+30', 1, GREEN)
        ...
        if self.player_health > 0:
            ...
            text = font.render ('-30', 1, RED)
            text2 = font2.render ('-30', 1, RED)
...
class projectile(object):
    virus = pygame.image.load('/Corona/images/bullets/CV60x60.png')
    ...
    def draw(self, win):
        win.blit(self.virus, (self.x - 22, self.y - 23))
...
class enemy(object):
    walkRight = [pygame.image.load('/Corona/images/char_bill/R1E.png'), pygame.image.load('/Corona/images/char_bill/R2E.png'), pygame.image.load('/Corona/images/char_bill/R3E.png'), pygame.image.load('/Corona/images/char_bill/R4E.png'), pygame.image.load('/Corona/images/char_bill/R5E.png'), pygame.image.load('/Corona/images/char_bill/R6E.png'), pygame.image.load('/Corona/images/char_bill/R7E.png'), pygame.image.load('/Corona/images/char_bill/R8E.png'), pygame.image.load('/Corona/images/char_bill/R9E.png'), pygame.image.load('/Corona/images/char_bill/R10E.png'), pygame.image.load('/Corona/images/char_bill/R11E.png')]
    walkLeft = [pygame.image.load('/Corona/images/char_bill/L1E.png'), pygame.image.load('/Corona/images/char_bill/L2E.png'), pygame.image.load('/Corona/images/char_bill/L3E.png'), pygame.image.load('/Corona/images/char_bill/L4E.png'), pygame.image.load('/Corona/images/char_bill/L5E.png'), pygame.image.load('/Corona/images/char_bill/L6E.png'), pygame.image.load('/Corona/images/char_bill/L7E.png'), pygame.image.load('/Corona/images/char_bill/L8E.png'), pygame.image.load('/Corona/images/char_bill/L9E.png'), pygame.image.load('/Corona/images/char_bill/L10E.png'), pygame.image.load('/Corona/images/char_bill/L11E.png')]
    ...
    def __init__(self, x, y, width, height, end):
        ...
        self.healthbar = (self.x - 85, self.y - 25, 170, 30)
    ...
    def draw(self,win):        
        ...
        if self.visible:
            ...
            if self.walkCount + 1 >= 33:
                ...
                self.hitbox = (10, 10, 58, 230)
                

            if self.vel > 0:
                if self.enemy_health > 50:
                    win.blit(self.walkRight[self.walkCount //3], (self.x, self.y))
                    pygame.draw.rect (win, RED, (self.healthbar[0], self.healthbar[1] - 0, 300, 20))
                    pygame.draw.rect (win, GREEN, (self.healthbar[0], self.healthbar[1] - 0, 300 - (1 * (300 - self.enemy_health)), 20))
    ...
    def move_low(self):
        if man.visible and self.enemy_health < 100:
            if self.vel > 0:
                if self.x + self.vel < self.path[1]:
                    self.x += self.vel 
    ...
    def shoot(self):
        if self.visible and man.visible and self.enemy_health < 250:
            facing = 0.3
    ...
    def jump(self):
        ...
        if self.visible and man.visible:
            if self.walkCount > 0:
                if self.jumpCount2 >= -17:
                    neg = 1
                    if self.jumpCount2 < 0:
                        neg = -1
                    self.y -= (self.jumpCount2 ** 2) * 0.2 * neg
                    self.jumpCount2 -= 1
    ...
    def hitBullet(self):
        if man.visible:
            if man.player_health < 150:
                man.player_health += 7
                font2 = pygame.font.SysFont('Comic Sans MS', 68)
                text2 = font2.render ('+7', 1, GREEN)
                win.blit (text2, man.add4)
                pygame.display.update()
            if self.enemy_health > 0:
                self.enemy_health -= 7
                font = pygame.font.SysFont('Comic Sans MS', 100)
                text = font.render ('-7', 1, RED)
                win.blit (text, self.hitbox)
    ...
    def hitSyringe(self):
        if man.visible:
            if man.player_health < 150:
                man.player_health += 15
                font2 = pygame.font.SysFont('Comic Sans MS', 68)
                text2 = font2.render ('+15', 1, GREEN)
...
class projectile_virus(object):
    virusEnemy = pygame.image.load('/Corona/images/bullets/CVG80x80.png')
...
def startGame():
    if 'highscore_leicht' in sys.modules:  
        del sys.modules['highscore_leicht']
        import highscore_leicht.py
    else:
        import highscore_leicht.py
...
def redrawGameWindow():
    ...
    if goblin.visible == False:
        ...
        winner = pygame.image.load('/Corona/images/winnings/winner.png')
        winner.set_alpha(210)
        win.blit(winner, (305,200))
        
        man.isJump = True
        
        if man.jumpCount + 1 >= 2:
            man.jumpCount = 0

        if man.isJump == True:
            win.blit(man.char, (man.x,man.y)) #----------------------------> FLY
            man.jumpCount += 1
    ...
    if goblin.visible and man.visible:
        ...
        text2 = font2.render('LEVEL 5', 1, BLUE)
            ...
            if bullet.y - bullet.radius < goblin.hitbox[1] + goblin.hitbox [3] and bullet.y + bullet.radius > goblin.hitbox[1]:
                if bullet.x + bullet.radius > goblin.hitbox[0] and bullet.x - bullet.radius < goblin.hitbox[0] + goblin.hitbox[2]:
                    ...
                    if man.player_health >=150:
                        ...
                        #text_score2 = font_score2.render ('+7', 1, BLUE)
            ...
            if syringe.y - syringe.radius < goblin.hitbox[1] + goblin.hitbox [3] and syringe.y + syringe.radius > goblin.hitbox[1]:
                if syringe.x + syringe.radius > goblin.hitbox[0] and syringe.x - syringe.radius < goblin.hitbox[0] + goblin.hitbox[2]:
                    ...
                    if man.player_health >=150:
                        score += 15
                        #font_score2 = pygame.font.SysFont('Comic Sans MS', 125)
                        #text_score2 = font_score2.render ('+15', 1, BLUE)
                        #win.blit (text_score2, man.score_double)
                        pygame.display.flip()
...
#Arrowkeys
    ...
    if not(man.isJump): 
        if keys[pygame.K_UP]:
            man.hitbox.move_ip(0, man.y *(man.vel))
            man.add3.move_ip(0, man.y *(man.vel))
            man.add4.move_ip(0, man.y *(man.vel))
            man.healthbar.move_ip(0, man.y *(man.vel))
            man.name.move_ip(0, man.y *(man.vel))
