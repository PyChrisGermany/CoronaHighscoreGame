...
def write_to_file(file_name, your_name, points):
    score_file_leicht = open(file_name, 'a')
    print (your_name+',', points, file=score_file_leicht)
    score_file_leicht.close()
...
def show_top10(screen, file_name):
    ...
    txt_surf = font3.render(' TOP 10 - LEICHT ', True, RED, GREEN)  # headline
...
def highscore_leicht(screen, file_name, your_points):
