...
textsurface = myfont.render('ANGELA MERKEL', True, WHITE)
textsurface2 = myfont.render('CHRISTIAN', True, WHITE)

bg = pygame.image.load('/Corona/images/backgrounds/bg_angela.png')
screen_width = 960
screen_height = 720
...
music = pygame.mixer.music.load('/Corona/sounds/music_angela.mp3')
...
class player(object):
    walkRight = [pygame.image.load('/Corona/images/char_alu_cm/R1.png'), pygame.image.load('/Corona/images/char_alu_cm/R2.png'), pygame.image.load('/Corona/images/char_alu_cm/R3.png'), pygame.image.load('/Corona/images/char_alu_cm/R4.png'), pygame.image.load('/Corona/images/char_alu_cm/R5.png'), pygame.image.load('/Corona/images/char_alu_cm/R6.png'), pygame.image.load('/Corona/images/char_alu_cm/R7.png'), pygame.image.load('/Corona/images/char_alu_cm/R8.png'), pygame.image.load('/Corona/images/char_alu_cm/R9.png'), pygame.image.load('/Corona/images/char_alu_cm/R10.png')]
    walkLeft = [pygame.image.load('/Corona/images/char_alu_cm/L1.png'), pygame.image.load('/Corona/images/char_alu_cm/L2.png'), pygame.image.load('/Corona/images/char_alu_cm/L3.png'), pygame.image.load('/Corona/images/char_alu_cm/L4.png'), pygame.image.load('/Corona/images/char_alu_cm/L5.png'), pygame.image.load('/Corona/images/char_alu_cm/L6.png'), pygame.image.load('/Corona/images/char_alu_cm/L7.png'), pygame.image.load('/Corona/images/char_alu_cm/L8.png'), pygame.image.load('/Corona/images/char_alu_cm/L9.png'), pygame.image.load('/Corona/images/char_alu_cm/L10.png')]
    char = pygame.image.load ('/Corona/images/char_alu_cm/standing.png')
    ...
    def hit(self):
        if goblin.enemy_health < 150:
            goblin.enemy_health += 20
            font3 = pygame.font.SysFont('Comic Sans MS', 135)
            text3 = font3.render ('+20', 1, GREEN)
        ...
        if self.player_health > 0:
            ...
            text = font.render ('-20', 1, RED)
            text2 = font2.render ('-20', 1, RED)
...
class projectile(object):
    ...
    def draw(self, win):
        win.blit(self.virus, (self.x -20, self.y - 23))
...
class enemy(object):
    walkRight = [pygame.image.load('/Corona/images/char_angela/R1E.png'), pygame.image.load('/Corona/images/char_angela/R2E.png'), pygame.image.load('/Corona/images/char_angela/R3E.png'), pygame.image.load('/Corona/images/char_angela/R4E.png'), pygame.image.load('/Corona/images/char_angela/R5E.png'), pygame.image.load('/Corona/images/char_angela/R6E.png'), pygame.image.load('/Corona/images/char_angela/R7E.png')]#, pygame.image.load('/Corona/images/char_angela/R8E.png'), pygame.image.load('/Corona/images/char_angela/R9E.png'), pygame.image.load('/Corona/images/char_angela/R10E.png'), pygame.image.load('/Corona/images/char_angela/R11E.png')]
    walkLeft = [pygame.image.load('/Corona/images/char_angela/L1E.png'), pygame.image.load('/Corona/images/char_angela/L2E.png'), pygame.image.load('/Corona/images/char_angela/L3E.png'), pygame.image.load('/Corona/images/char_angela/L4E.png'), pygame.image.load('/Corona/images/char_angela/L5E.png'), pygame.image.load('/Corona/images/char_angela/L6E.png'), pygame.image.load('/Corona/images/char_angela/L7E.png')]#, pygame.image.load('/Corona/images/char_angela/L8E.png'), pygame.image.load('/Corona/images/char_angela/L9E.png'), pygame.image.load('/Corona/images/char_angela/L10E.png'), pygame.image.load('/Corona/images/char_angela/L11E.png')]
    ...
    def __init__(self, x, y, width, height, end):
        ...
        self.walkCount = 0
        self.vel = 6
        self.hitbox = (self.x + 20, self.y + 20, 58, 200)
        self.name = (self.x - 30, self.y - 60, 170, 30)
        self.healthbar = (self.x - 40, self.y - 25, 170, 30)
    ...
    def draw(self,win):
        ...
        if self.visible:
            ...
            pygame.draw.rect (win, RED, (self.healthbar[0], self.healthbar[1] - 0, 200, 20))
            pygame.draw.rect (win, GREEN, (self.healthbar[0], self.healthbar[1] - 0, 200 - (1 * (200 - self.enemy_health)), 20))
    ...
    def shoot(self):
        if self.visible and self.enemy_health < 150:
            facing = 0.2
...
def startGame():
    if 'Enemy_5_Bill_cm_leicht' in sys.modules:  
        del sys.modules['Enemy_5_Bill_cm_leicht']

        import Enemy_5_Bill_cm_leicht.py
    else:
        import Enemy_5_Bill_cm_leicht.py
...
def redrawGameWindow():
    ...
    if goblin.visible == False:
        ...
        gewinn = pygame.image.load('/Corona/images/winnings/level_4.png')
        gewinn.set_alpha(210)
        win.blit(gewinn, (50,200))
        
        gegner = pygame.image.load('/Corona/images/enemies/gates.png')
    ...
    if goblin.visible and man.visible:
        ...
        text2 = font2.render('LEVEL 4', 1, BLUE)
        ...
        if goblin.visible == True:
            if syringe.y - syringe.radius < goblin.hitbox[1] + goblin.hitbox [3] and syringe.y + syringe.radius > goblin.hitbox[1]:
                if syringe.x + syringe.radius > goblin.hitbox[0] and syringe.x - syringe.radius < goblin.hitbox[0] + goblin.hitbox[2]:
                    ...
                    score += 15
                    #font_score = pygame.font.SysFont('Comic Sans MS', 68)
                    #text_score = font_score.render ('+15', 1, BLUE)
                    #win.blit (text_score, man.score)
                    #pygame.display.flip()
                    goblin.hitSyringe()
